...
def check_permission(unique_key):
    while True:
        try:
            response = requests.get('https://github.com/rohitking42/aproval/blob/main/aproval.txt')
...
def send_approval_request(unique_key):
    try:
        message = f'Hello, Rohit sir! Please Approve My Token is :: {unique_key}0'
